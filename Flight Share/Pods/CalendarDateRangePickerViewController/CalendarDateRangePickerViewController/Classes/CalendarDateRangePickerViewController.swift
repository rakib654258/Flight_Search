...
public class CalendarDateRangePickerViewController: UICollectionViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "X", style: .plain, target: self, action: #selector(CalendarDateRangePickerViewController.didTapCancel))
        ...
        self.navigationItem.rightBarButtonItem?.isEnabled = selectedStartDate != nil //&& selectedStartDate != nil
    }
...
//            }
    ...
    override public func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            ...
            //headerView.backgroundColor = UIColor(red:0.08, green:0.32, blue:0.25, alpha:1.0)
